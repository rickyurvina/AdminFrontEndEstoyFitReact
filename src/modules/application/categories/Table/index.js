...
import {getCategories, saveCategory, deleteCategory} from '../../../../@crema/services/applicationServices/category';
...
class Table extends React.Component {
  ...
  send = async (urlFile)  => {
    ...
    const response = await saveCategory(objectSend);
    const { data } = response;
  ...
  render() {
    ...
    : 
      ...
      >
        ...
        <DialogContent>
          <DialogContentText>
            En este espacio puedes editar una categoría.
          </DialogContentText>
          <div className="row col">
            ...
            <FormHelperText>Imagen categoria</FormHelperText>
          </FormControl>
