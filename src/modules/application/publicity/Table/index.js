...
import {getPublicities, savePublicity, deletePublicity} from '../../../../@crema/services/applicationServices/publicity';
...
class Table extends React.Component {
  ...
  getPublicities = async () => {
    this.setState({loadingTable: true});
    const resp = await getPublicities();
  ...
  confirmDelete = (e, row) => {
    ...
    Swal.fire({
      title: 'Está seguro de que desea eliminar esta publicity?',
  ...
  send = async (urlFile, bannerImageUrl)  => {
    ...
    const response = await savePublicity(objectSend);
    const { data } = response;
  ...
  render() {
    ...
    : 
      ...
      >
        ...
        <DialogContent>
          <DialogContentText>
            En este espacio puedes editar el publicity home.
          </DialogContentText>
